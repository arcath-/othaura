...
namespace Othaura.Core {
    ...
    public class Player : Actor {
        ...
        private void DrawAbility(IAbility ability, Console inventoryConsole, int position) {
            ...
            Color highlightTextColor = Palette.DbOldStone;
            ...
            if (ability.TurnsToRefresh > 0) {
                ...
                Monster.SetBackColor(inventoryConsole, xHighlightPosition, yPosition, width, 1, Palette.DbOldBlood);
                Monster.SetBackColor(inventoryConsole, xHighlightPosition + width, yPosition, remainingWidth, 1, Colors.OBlack);
            }
        }
